  ...
  return (
    <DefaultLayout margin={1}>
      ...
      <div className="w-full overflow-hidden">
        <EmblaCarousel imageUrls={nydiaImageURLs} imageAlts={nydiaImageAlts} folder="Nydia" delay={2500} options={{ loop: true, duration: 50 }} arrows name="Nydia Track" description="
        ...
        />
        <EmblaCarousel imageUrls={quailImageURLs} imageAlts={quailImageAlts} folder="Quail" delay={2500} options={{ loop: true, duration: 50 }} arrows name="Quail Stream Walk" description="
