    ...
    <DefaultLayout>
      <div className="flex flex-col gap-6">
        ...
        <div className="flex sm:flex-row flex-col justify-around gap-6">
          ...
          />
          <div className="grow hidden sm:block max-w-[20%]"></div>
          <Card>
            <CardHeader className="text-2xl font-bold justify-center">Personal Gear List</CardHeader>
            <CardBody>
              <ul className="pl-6 list-disc">
                <li>Backpack (40-60 liter size) for multi-day hiking</li>
        ...
        <div className="flex sm:flex-row-reverse flex-col justify-around gap-6 items-center">
          <Image
            isZoomed
            src={
              "https://raw.githubusercontent.com/sonicpanther101/school-website-2025/refs/heads/main/Images/" +
        ...
        <div className="flex sm:flex-row flex-col justify-around gap-6 items-center">
          <Image
            isZoomed
            src={
              "https://raw.githubusercontent.com/sonicpanther101/school-website-2025/refs/heads/main/Images/" +
          ...
          <div className="grow shrink hidden sm:block max-w-[20%]"></div>
          <Card className="h-full">
            <CardHeader className="text-2xl font-bold justify-center">Miscellaneous Advice</CardHeader>
            <CardBody className="flex  justify-center">
              <ul className="pl-6 list-disc">
                ...
                <li>Wear sturdy hiking boots with good grip and ankle support.</li>
